...
import com.code.sharedpreferences.databinding.ActivityFormUserPreferenceBinding
...
//        userModel = if(VERSION.SDK_INT >= 33){
...
//        }
    ...
    override fun onClick(v: View?) {
        if(v?.id == R.id.btn_save){
            ...
            val isLoveMu = binding.rgLoveMenu.checkedRadioButtonId == R.id.rb_yes
